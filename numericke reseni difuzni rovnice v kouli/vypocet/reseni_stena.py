...
c0=10000 #pocatecni koncentrace v Bq/m^3
...
anim_t1=animace(vysledek_t1,c_u_t1,c0,tau_t1,k_t1,'tekute', interval=1)
anim_p1=animace(vysledek_p1,c_u_p1,c0,tau_p1,k_p1,'pevne', interval=1)
...
anim_t2=animace(vysledek_t2,c_u_t2,0,tau_t2,k_t2,'tekute', interval=1)
anim_p2=animace(vysledek_p2,c_u_p2,0,tau_p2,k_p2,'pevne', interval=1)
