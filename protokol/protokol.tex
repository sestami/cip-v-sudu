...
\begin{figure}[H]
	...
	\begin{subfigure}{0.49\textwidth}
		...
		\caption{}
	\end{subfigure}
\caption{V (a) je originální beta spektrum \ce{^{214}Pb} přebrané z \cite{betaSpektrum}. V (b) je histogram $10^6$ realizací náhodné veličiny řídící se rozdělením, jehož hustota pravděpodobnosti je rovna beta spektru z (a).}
\end{figure}
\begin{figure}[H]
	\centering
	\begin{subfigure}{0.49\textwidth}
